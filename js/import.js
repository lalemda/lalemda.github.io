...
(function () {
    ...
    let mainPathname = ['home','saliyat.html','zemzem.html','balenge.html','shemsiya.html','all-family.html',
                        ...
                        'news1.html', 'news2.html', 'news3.html', 'lalemda-association.html',
                    ]   
    ;
    ...
    function setClassName() {
        ...
        [236,237,238,239,240,241,242,243,244].forEach( v => {                  /** All Home - Lalemda, Gallery,  */
            if(pathnameTruth.indexOf('true') === v) { 
                className.ho = 'active';
                setUrl.baseHome = '../../';
    ...
    function mainFooterFn() {
        return `
            <footer>
                <div class="inner-footer-container-1 _grid-column-4">
                    ...
                    <div class="col">
                        ...
                        <ul>
                            ...
                            <li><a href="../../../lalemda/ho/lalemda-association.html"><span class="_en">About Lalemda Association</span><span class="_st hide-lang">ስለ ላለምዳ ማህበር</span></a></li>
                        </ul>
                    </div>
                    <div class="col">
                ...
                <div id="passwordContainer" class="password-container hide-pass">
                    <div class="inner-pass-container">
                        <h2>Wellcome to Lalemda's Family</h2>
                        <div class="password-input">
                            <input type="password" id="passwordInput" placeholder="Enter the password">
                            <button id="checkPass">Log In</button>
                        </div>
                        <div class="check-box">
